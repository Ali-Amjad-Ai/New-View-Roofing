...
export default function MainHero({ onNavigate }: MainHeroProps) {
  return (
    <section className="relative bg-[#0a0e1a] pt-20 pb-28 md:py-32 overflow-hidden font-sans" id="hero-section">
      ...
      {/* Absolute colored radial ambient light */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 space-y-8 text-left animate-fadeIn">
            ...
            <div className="inline-flex flex-wrap gap-2.5 items-center p-1.5 bg-[#121829]/80 border border-[#1e293b] rounded-full text-xs font-medium text-slate-300 shadow-sm">
              <span className="px-3 py-1 bg-gradient-to-r from-amber-600 to-amber-500 text-slate-950 font-extrabold rounded-full text-[10px] uppercase tracking-wider">
                Certified
              </span>
            ...
            <div className="space-y-4">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-white tracking-tight leading-tight md:leading-none">
                Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-amber-500 to-amber-600">Dallas-Fort Worth</span>
                <br />
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
              <button
                ...
                className="px-8 py-4 bg-gradient-to-r from-amber-600 to-amber-500 hover:from-amber-500 hover:to-amber-400 text-slate-950 font-extrabold text-xs uppercase tracking-wider rounded-xl shadow-lg shadow-amber-500/10 hover:shadow-amber-500/25 hover:-translate-y-0.5 active:scale-98 transition-all flex items-center justify-center space-x-2 cursor-pointer font-sans"
              >
            ...
            <div className="pt-8 border-t border-[#1e293b] grid grid-cols-3 gap-6">
              ...
              <div className="space-y-1">
                <p className="text-2xl md:text-3xl font-black text-amber-500 tracking-tight">Top 3%</p>
          ...
          <div className="lg:col-span-5 relative" id="hero-form-wrapper">
            ...
            <div className="absolute -inset-2 bg-gradient-to-r from-amber-500 to-indigo-500 rounded-2xl opacity-10 blur-xl pointer-events-none"></div>
